...
HGLOG="/backup/mis/log/$HOSTNAME_`date +%Y%m%d`_hs_good.log"
HBLOG="/backup/mis/log/$HOSTNAME_`date +%Y%m%d`_hs_error.log"
SGLOG="/backup/mis/log/$HOSTNAME_`date +%Y%m%d`_share_good.log"
SBLOG="/backup/mis/log/$HOSTNAME_`date +%Y%m%d`_share_error.log"
