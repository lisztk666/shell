...
nice -n -20 apt install  ntpdate pv s-tui gpart ethtool git  hwloc bridge-utils  btop lnav ntfs-3g progress gddrescue mdadm jq -y
nice -n -20 apt install glances rsyslog  inotify-tools duf -y
